...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 08, 2024 at 06:34 AM
...
CREATE TABLE `account` (
  `acccuntID` int(11) NOT NULL,
  `userID` int(11) NOT NULL,
  `districtID` int(11) NOT NULL,
  `account_first_name` int(11) NOT NULL,
  `account_middle_name` int(11) NOT NULL,
  `account_last_name` varchar(255) NOT NULL,
  `account_grade` varchar(10) NOT NULL,
  `account_section` varchar(255) NOT NULL,
  `account_rank` varchar(255) NOT NULL,
...
(1, '1', 'Jack', 'N', 'Poy', '3', 'Naraka', 'Growing Usa', 'soil.png', '7th gate', 'Hell ', 'Norway', 'jackthereaper@gmail.com', '095326686569', 'John_Dasmodeus@gmail.com', '095656665321', '7th Gate@gmail.com', '2024-06-19 12:22:34');
...
--
ALTER TABLE `account`
  MODIFY `acccuntID` int(11) NOT NULL AUTO_INCREMENT;
