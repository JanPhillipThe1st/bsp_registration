    ...
    <div class="container-fluid border rounded border-success m-auto w-100 my-5 p-3 shadow" style="overflow:hidden !important;background-color:#fafafa !important;">
        ...
        <div class="row d-flex align-items-center m-auto">
            <div class="col-3 mx-1 contact-us-card">
                ...
                <div class="row">
                    <h5 class="my-4 text-center">Sto. Niño, Pagadian City, <br> Zamboanga del Sur</h5>
                </div>
            </div>
            <div class="col-3 mx-1 contact-us-card">
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-8">
                                <h5 class="my-4 text-center">0953-765-9982</h5>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-8">
                                <h5 class="my-4 text-center">0909-123-9382</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-3 mx-1 contact-us-card">
                    ...
                    <div class="row">
                    <h5 class="my-4 text-center">pagadianbsp@gmail.com</h5>
                    </div>
